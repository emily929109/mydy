      ...
      return [r].flat().reduce((s3, a2) => {
        if (a2 != null) {
          ...
          if (u === "string" || u === "number") s3.push(a2);
            ...
            let p3 = Array.isArray(a2) ? o(n, a2) : Object.entries(a2).map(([f, g2]) => n === "style" && (g2 || g2 === 0) ? `${f.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${g2}` : g2 ? f : void 0);
            s3 = p3.length ? s3.concat(p3.filter((f) => !!f)) : s3;
          }
        }
        return s3;
      }, i2);
...
function de(e, t = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g2 = m2[u], f = ve(g2), p3 = G(u, a2) ? Q(d2) : Q(d2, re(u));
      if (i(f)) o.push({ node: f, path: p3 });
      else {
        let y2 = ae2(p3), R = Y2(f, p3, s3, [a2]);
        Re(l2, y2, R);
        let T2 = p3;
...
var b = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(a2) && n.transform !== "strict") {
    ...
    let et = this.transformCSS(e, `${He}${qe}color-scheme:light`, "light", "variable", n, s3, i2), tt3 = this.transformCSS(e, `${Fe}color-scheme:dark`, "dark", "variable", n, s3, i2);
    d2 = `${et}${tt3}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m(a2.css, { dt: E });
  }
...
var camelize = cacheStringFunction(
  (str) => {
    return str.replace(camelizeRE, (c3) => c3.slice(1).toUpperCase());
  }
);
...
function recordPosition(c3) {
  newPositionMap.set(c3, {
    left: c3.el.offsetLeft,
    top: c3.el.offsetTop
  });
}
...
function useStyle(css3) {
  ...
  var load2 = function load3(_css) {
    ...
    stop2 = watch2(cssRef, function(value) {
