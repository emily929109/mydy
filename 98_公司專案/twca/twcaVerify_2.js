  ...
  setup() {
    ...
    onMounted(() => {
      axios({
        ...
        //params: { idno: u.id.v, mobileno: u.mobile.v, tmpKeyCount: u.tmpkey.v }
      })
        .then((response) => {
          // 0000 是外部 twca api 回應格式的一部分
    ...
    const Send = (u) => {
      ...
      if (!u.agree.v) {
        u.agree.error = "ng";
        u.agree.msg = "請詳閱服務使用者約定條款及隱私權告知條款";
      } else {
        u.agree.error = "ok";
        u.agree.msg = "";
      }
      ...
      if (u.agree.error == "ok") {
        window.location.href = "../Home/TwcaVerify_3";
      }
    };
