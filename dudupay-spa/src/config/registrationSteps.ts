...
// 7 步驟的順序/路徑/標題單一事實來源。RegisterWizardNav、router、store 都讀這份
export const registrationSteps: RegistrationStepMeta[] = [
  ...
  {
    key: "step4TwcaConsent",
    path: "/register/twca/consent",
    title: "門號同意",
    order: 4,
  },
  {
    key: "step5TwcaClause",
    path: "/register/twca/clause",
    title: "條款同意",
    order: 5,
  },
  {
    key: "step6TwcaVerify",
    path: "/register/twca/verify",
    title: "身分驗證",
    order: 6,
  },
