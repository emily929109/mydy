...
const STEP_KEY = 'step4TwcaConsent'
...
<template>
  <RegisterStepLayout next-label="標記完成並前往下一步" @next="markCompleteAndContinue">
    <p class="text-muted">placeholder，實作見 issue 08（含「非本人」跳過分支）</p>
  </RegisterStepLayout>
</template>
