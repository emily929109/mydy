const App = {
  setup() {
    ...
    const Next = (u) => {
      ...
      var hasUpper = false;
      for (var i = 0; i < 26; i++) {
        if (ru.value.pw_register.v.indexOf(letters[i]) != -1) {
          //有大寫
          hasUpper = true;
          break;
        }
      ...
      if (!hasUpper) {
        ru.value.pw_register.error = "ng";
        ru.value.pw_register.msg = "要有英文大寫";
        //alert('要有英文大寫');
        return;
      } else {
        ru.value.pw_register.error = "ok";
      ...
      var hasLower = false;
      for (var i = 0; i < 26; i++) {
        if (ru.value.pw_register.v.indexOf(letters2[i]) != -1) {
          //有小寫
          hasLower = true;
          break;
        }
      ...
      if (!hasLower) {
        ru.value.pw_register.error = "ng";
        ru.value.pw_register.msg = "要有英文小寫";
        //alert('要有英文小寫');
        return;
      } else {
        ru.value.pw_register.error = "ok";
      ...
      var hasNumber = false;
      for (var i = 0; i < 10; i++) {
        if (ru.value.pw_register.v.indexOf(letters3[i]) != -1) {
          hasNumber = true;
          break;
        }
      }
      ...
      for (var i = 0; i < 7; i++) {
        if (ru.value.pw_register.v.indexOf(letters4[i]) != -1) {
          hasSpecChar = true;
          break;
        }
      }
      if (hasSpecChar) {
        ru.value.pw_register.error = "ng";
        ru.value.pw_register.msg = "不能有特殊字如: !@#$%&";
        //alert('不能有特殊字如: !@#$%&');
        return;
      } else {
        ru.value.pw_register.error = "ok";
      ...
      //check repw
      if (ru.value.pw_register.v != ru.value.repw_register.v) {
        ru.value.repw_register.error = "ng";
        ru.value.repw_register.msg = "請再輸入相同的值";
      } else {
