...
const App = {
  setup() {
    ...
    const Send = async (u) => {
      //check 發票索取方式
      if (u.voice_type.v == "" || !u.voice_type.v) {
      ...
      console.log(u.voice_type.v);
      console.log(u.voice_subtype.v);

      //檢查二聯電子發票
      if (u.voice_type.v == "1") {
        if (!u.voice_subtype.v || u.voice_subtype.v == "") {
          u.voice_type.error = true;
      ...
      if (u.voice_type.v == "2") {
        //請輸入統編
        if (!u.voice_txt_comp.v || u.voice_txt_comp.v == "") {
          //null
      ...
      console.log(u.voice_type.v);
      console.log(u.voice_subtype.v);
      //console.log(u.voice_subtype_2.v);
      console.log(u.voice_txt_cq.v);
      console.log(u.voice_txt_comp.v);
      console.log(u.voice_txt_oaddress.v);
      console.log(u);
      if (
